...
A composite action used by Storm Software repositories to setup development environments.
...
Set up a Node.js development environment in a GitHub actions workflow.
...
Once the code is pulled locally, open a command prompt and run `pnpm install` to install the dependencies.
